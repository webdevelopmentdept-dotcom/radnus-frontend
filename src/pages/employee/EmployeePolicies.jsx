        ...
        <div className="container-fluid" style={{ padding: 28 }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <button onClick={closePolicy} style={{
                    ...
                    padding: "7px 16px", cursor: "pointer", color: "#dc2626", fontWeight: 600, fontSize: 13,
                  }}>✕ Close</button>
                </div>
                ...
                <div style={{ flex: 1, overflow: "hidden", position: "relative" }}>
                  ...
                  {fileType === "image" && (
                    <div style={{ height: "100%", overflow: "auto", display: "flex", alignItems: "center", justifyContent: "center", padding: 20, background: "#f8fafc" }}>
                      <img src={selectedPDF} alt="Policy" onLoad={() => setIframeLoading(false)}
                        style={{ maxWidth: "100%", maxHeight: "100%", borderRadius: 8, objectFit: "contain" }} />
                    </div>
                  )}
                  {(fileType === "pdf" || fileType === "docx") && (
                    <iframe key={viewerUrl} src={viewerUrl}
                      style={{ width: "100%", height: "100%", border: "none", display: "block" }}
                      title="Policy Document" onLoad={() => setIframeLoading(false)} />
                  )}
                </div>
                  ...
                  {isAcknowledged(selectedPolicy?._id) ? (
                    ...
                    <div>
                      <p style={{ margin: "0 0 10px", fontSize: 12, color: "#64748b" }}>
                        Read the document fully, then take a short quiz to acknowledge.
                      </p>
                      <button
                        onClick={() => { closePolicy(); handleAcknowledgeClick(selectedPolicy); }}
                        style={{
          ...
          {quizPolicy && (
            <PolicyQuizModal
              ...
              onPass={() => markAcknowledged(quizPolicy._id)}
              onClose={() => setQuizPolicy(null)}
            />
          )}
            ...
            <div className="card-body">
              <div style={{ marginBottom: 20 }}>
                ...
                <p style={{ fontSize: 13, color: "#64748b", margin: "4px 0 0" }}>
                  Read each policy and pass a short quiz to acknowledge it
                </p>
              </div>
                        ...
                        return (
                          <div key={p._id} style={{
                            ...
                            <div style={{ padding: 18 }}>
                              ...
                              <h3 style={{ fontSize: 14, fontWeight: 700, margin: "0 0 4px", color: "#1e293b" }}>{p.title}</h3>
                              ...
                              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
                                <span style={{ fontSize: 11, fontWeight: 700, color: acked ? "#16a34a" : "#d97706" }}>
                                  {acked ? "✓ Acknowledged" : "⚠ Pending Quiz"}
                                </span>
                                <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                                  ...
                                  {!acked && (
                                    <button
                                      onClick={() => handleAcknowledgeClick(p)}
                                      style={{
                            ...
                            {showVersions && versions.length > 1 && (
                              <div style={{ borderTop: "1px solid #e2e8f0", background: "#f8fafc", padding: "12px 18px" }}>
                                <p style={{ fontSize: 11, fontWeight: 700, color: "#64748b", margin: "0 0 10px", textTransform: "uppercase", letterSpacing: 0.5 }}>
                                  Version History
                                </p>
                                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                  {[...versions].reverse().map((v, idx) => (
                                    <div key={`${v.version_number}-${idx}`} style={{
                                      ...
                                      background: "#fff", border: `1px solid ${idx === 0 ? "#93c5fd" : "#e2e8f0"}`,
              ...
              {!loading && policies.length > 0 && (
                <div style={{
                  ...
                  <span style={{ color: "#d97706", fontWeight: 600 }}>⚠ Pending: {policies.length - acknowledgedIds.length}</span>
                </div>
              )}
            </div>
          </div>
