...
export default function EmployeePolicies() {
    ...
    const getVersions = (policy) => {
        if (Array.isArray(policy.version_history) && policy.version_history.length > 0) {
            // Sort ascending by version_number so latest is last
            const sorted = [...policy.version_history].sort((a, b) => a.version_number - b.version_number);

            // ✅ FIX: If all version_numbers are the same (backend bug), assign display numbers by position
        ...
        // Fallback if version_history is empty
        return [{
    ...
    return (
        <div style={{ padding: 24, fontFamily: "inherit" }}>
            ...
            <div style={{ marginBottom: 24 }}>
                <h2 style={{ fontSize: 22, fontWeight: 700, margin: 0 }}>Company Policies</h2>
                                        ...
                                        <div style={{ padding: 18 }}>
                                            ...
                                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                                ...
                                                <div style={{ display: "flex", gap: 8 }}>
                                                    ...
                                                    {/* Toggle versions — only if more than 1 */}
                                                    {versions.length > 1 && (
                                                        <button
                                        ...
                                        {showVersions && versions.length > 1 && (
                                            <div style={{
                                                ...
                                                <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                                                    {/* ✅ FIX: Show latest first using reversed array with correct display_version */}
                                                        ...
                                                        <div key={`${v.version_number}-${idx}`} style={{
                                                            ...
                                                            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                                                <span style={{
                                                                    ...
                                                                    {/* ✅ Use display_version for correct v1, v2, etc. */}
                                                                    v{v.display_version}
                                                                </span>
                                                                {idx === 0 && (
                                                                    <span style={{
