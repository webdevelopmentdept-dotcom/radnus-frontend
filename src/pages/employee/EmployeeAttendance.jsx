    ...
    <EmployeeLayout>
      ...
      <div className="ea-root">
        ...
        <header className="ea-topbar">
          ...
          {employee && (
            <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
              <div style={{ textAlign: "right", display: "none" }} className="emp-info-desktop">
        ...
        {toast && (
          <div
            className="ea-toast"
            style={{ background: toast.type === "error" ? "#dc2626" : "#111827", color: "#fff" }}
          >
            <div style={{
              width: 6, height: 6, borderRadius: "50%", flexShrink: 0,
              background: toast.type === "error" ? "#fca5a5" : "#6ee7b7",
            }} />
            {toast.msg}
          </div>
        )}
        ...
        {/* ── Leave Modal ── */}
        {showLeaveForm && (
          <LeaveForm onSubmit={handleLeaveSubmit} onClose={() => setShowLeaveForm(false)} />
        )}
        ...
        <div className="ea-page">
          ...
          <div className="stat-row">
            {SUMMARY_CARDS.map((c) => (
              ...
              >
                ...
                <div style={{ fontSize: 11, color: c.color, fontWeight: 500, marginTop: 5, opacity: 0.75 }}>
                  {c.label}
                </div>
              </div>
            ))}
          ...
          <div className="ea-tabs">
            {TABS.map((t) => (
              <button
                key={t.id}
                className={`ea-tab${activeTab === t.id ? " active" : ""}`}
                ...
                {hasCheckedIn && (
                  <div className="time-stats">
                    {[
                      ...
                      >
                        <div style={{ fontSize: 12, fontWeight: 600, color: "#fff", fontFamily: "'DM Mono', monospace" }}>
                          {s.value}
                        </div>
                        <div style={{ fontSize: 9, color: "rgba(255,255,255,0.3)", marginTop: 4, fontWeight: 600, letterSpacing: 0.8, textTransform: "uppercase" }}>
                          {s.label}
                        </div>
                      </div>
                    ))}
                    ...
                    {[...records].sort((a, b) => new Date(b.date) - new Date(a.date)).map((r, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {r.remark && (
                            <div style={{ marginTop: 8, fontSize: 11, color: "#6b7280", fontStyle: "italic" }}>"{r.remark}"</div>
                          )}
                        </div>
                      );
                    })}
                      ...
                      <div key={i} className="ea-card" style={{ padding: "16px 18px" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 10 }}>
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            {l.hr_remark && (
                              <div style={{ marginTop: 7, fontSize: 12, color: "#0369a1", fontWeight: 500 }}>
                                HR Note: {l.hr_remark}
                              </div>
                            )}
                          </div>
                          <span style={{ fontSize: 11, color: "#d1d5db", fontWeight: 500, flexShrink: 0 }}>
                            Applied {fmtD(l.createdAt)}
                          </span>
                        </div>
                      </div>
                    );
