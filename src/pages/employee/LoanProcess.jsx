    ...
    <EmployeeLayout>
      <div className="lp-root container-fluid px-4 py-4">
        <style>{`
          ...
          .lp-field input:focus { outline: none; border-color: var(--lp-primary); background: var(--lp-surface); }
          .lp-field input.lp-input-invalid { border-color: var(--lp-danger); background: var(--lp-danger-soft); }
            ...
            <div className="lp-card">
              ...
              <div className="lp-doc-grid">
                {DOC_FIELDS.map((doc) => (
                  <div key={doc.key}>
                    <label
                      className={`lp-doc-box ${files[doc.key] ? "filled" : ""} ${
                        docErrors[doc.key] ? "invalid" : ""
                      }`}
                    >
                      ...
                      <div className="lp-doc-grid">
                        {DOC_FIELDS.map((doc) => {
                          ...
                          return (
                            <div key={doc.key}>
                              <label
                                className={`lp-doc-box ${uploaded || newFile ? "filled" : ""} ${
                                  editDocErrors[doc.key] ? "invalid" : ""
                                }`}
                              >
                                <div className="lp-doc-label">{doc.label} *</div>
                                <div className="lp-doc-status">
