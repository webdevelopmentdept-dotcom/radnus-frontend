        ...
        <div className="container">
          ...
          <p className="mb-4 " style={{ fontSize: "1.2rem" }}>
            ...
            trust through quality, innovation, and job-ready skills.
                ...
                <p className="mb-4" style={{ fontSize: "1.2rem" }}>
  <strong>Shirdi Enterprises</strong> is our parent company, providing
  strategic leadership, operational support, and long-term vision.
  Under its guidance, Radnus Communication continues to grow with
  strong values, reliability, and sustainable expansion.
</p>
