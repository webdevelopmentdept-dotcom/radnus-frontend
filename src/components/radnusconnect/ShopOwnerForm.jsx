...
=======
  ...
  /* ================= VALIDATION HELPER ================= */
>>>>>>> 223158a66feb274b8158390eeece251e6c00f716
...
{step === 1 && (
  <>
    ...
    <div className="row g-3">
      ...
      {/* Years in Business */}
      <div className="col-md-6">
        <label className={errors.businessYears ? "text-danger" : ""}>
          Years in Business
        </label>
        <select
...
{step === 2 && (
  <>
    ...
    {["Hardware", "Software / Unlocking", "iPhone Specialist", "All-round"].map(
      (v) => (
        <div className="form-check" key={v}>
          <input
            type="checkbox"
...
=======
                  onClick={handleSubmit}   // ✅ ONLY HERE
>>>>>>> 223158a66feb274b8158390eeece251e6c00f716
                >
